...
module Analyzable
  ...
  class Transaction < ApplicationRecord
    ...
    belongs_to :parent_transaction, class_name: 'Analyzable::Transaction', foreign_key: 'parent_transaction_id'
    has_many :sub_transactions, class_name: 'Analyzable::Transaction', foreign_key: 'parent_transaction_id'
